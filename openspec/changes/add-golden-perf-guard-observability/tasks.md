...
- [x] 1.7 Add CI job to run `make golden`, upload `golden.json`, and enforce pass conditions
- [x] 1.8 Add soak test script + invariants (multi-segment, Range fetch, merged audio, periodic cancel)
- [x] 1.9 Document CI env vars needed for Golden + soak
